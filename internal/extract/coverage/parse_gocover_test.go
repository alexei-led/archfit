...
`)
	...
	want := []evidence.CoverageFact{
		{File: "/checkout/app/b.go", CoveredUnits: 0, TotalUnits: 1, Unit: "statements", Format: FormatGoCoverProfile},
		{File: "example.com/acme/app/a.go", CoveredUnits: 3, TotalUnits: 3, Unit: "statements", Format: FormatGoCoverProfile},
	}

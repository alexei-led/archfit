// Package ports defines the evidence-acquisition hexagonal port interfaces that
// separate the engine orchestrator from its evidence adapters. Both the engine
// (consumer) and adapters (producers/implementors) import this neutral package —
// neither imports the other.
//
// This package owns only the evidence ports (Extractor, PatternProvider,
// SymbolResolver, SyntaxProvider) and their Nop implementations. The rendering
// port (Renderer) lives in internal/report/ports.
package ports

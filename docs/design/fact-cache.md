...
Status: approved design (Wave 6 Task 1, plan `docs/plans/completed/20260702-wave6-perf-cache.md`).
...
`internal/history/git/worktree.go`): same ref ⇒ same SHA ⇒ same absolute root ⇒ the

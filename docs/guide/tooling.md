...
| `gitnexus`                         | optional `risk_hub` enrichment       | `1.6.8`                                           | `npm install -g gitnexus@1.6.8`                                                                                              | <https://github.com/abhigyanpatwari/GitNexus>                | Requires Node `>=22`; archfit also needs a present `.gitnexus/` or `.codegraph` index. Follow GitNexus docs for new-index workflow. |

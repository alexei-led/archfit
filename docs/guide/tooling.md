...
| `scip-go`                          | Go edge-strength precision for `coupling_balance`            | `v0.2.7`                                          | `go install github.com/scip-code/scip-go/cmd/scip-go@v0.2.7`                                                               | <https://github.com/sourcegraph/scip-go>                 | Ensure `$(go env GOPATH)/bin` or `GOBIN` is on `PATH`.                             |

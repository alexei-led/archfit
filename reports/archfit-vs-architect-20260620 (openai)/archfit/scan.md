...
**Verdict:** pass (exit 0)
**Config hash:** `050365493f0f143d5fb515fc1df2b0f8f7089a9544904952c02defde719cf949`
...
- LOC: cmd/archfit (2896), internal/initcfg (2018), internal/metrics/modularity (1515), internal/engine (796), internal/config (765)
...
- **structural_weight**: 3 god-module(s) (median 200 LOC): cmd/archfit (2896 LOC, 14x), internal/initcfg (2018 LOC, 10x), .../metrics/modularity (1515 LOC, 7x) — info
- **complexity**: 17 complex function(s) (CCN>15): Build CCN 26 (.../facts/facts.go:32), writeModuleStanza CCN 26 (.../initcfg/initcfg.go:368), Calculate CCN 23 (.../modularity/hidden_coupling.go:27), Calculate CCN 22 (.../modularity/change_coupling.go:50), postVerify CCN 21 (.../archfit/review.go:244)+12 more — info
- **risk_hub**: 91 risk hub(s): internal/config [breadth 128, ×0.66, gn×1.87→157.70], internal/initcfg [breadth 179, ×0.66, gn×1.27→149.64], .../model/signal [breadth 74, ×1.00, gn×1.70→125.80], .../model/diagnostic [breadth 70, ×1.00, gn×1.73→121.33], .../model/coupling [breadth 69, ×1.00, gn×1.73→119.60]+86 more — info

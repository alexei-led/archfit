...
- **change_locality**: 30 cross-module edge(s) from 196 changed file(s); forward reach 39 file(s) — info
...
- **propagation_cost**: PC=0.105 (N=119); 9 modules reach >50%: .../codegraph/ts (99%), .../index/ts (97%), .../index/ts (83%), .../daemon/ts (83%), .../engine/ts (83%)+4 more — info
...
- unresolved modules: 2 (edges to unknown modules use conservative distance)
